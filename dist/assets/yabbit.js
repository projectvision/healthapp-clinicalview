...
define('yabbit/models/parse-user', ['exports', 'ember', 'ember-data', 'ember-parse-adapter/models/parse-user'], function (exports, Ember, DS, ParseUser) {
  ...
  ParseUser['default'].reopenClass({
    ...
    isPhysician: DS['default'].attr('boolean'),
...
define('yabbit/models/patient', ['exports', 'ember', 'ember-data'], function (exports, Ember, DS) {
  ...
  exports['default'] = DS['default'].Model.extend({
    ...
    healthRisk: Ember['default'].computed('zScore', function () {
    ...
    activityLevel: Ember['default'].computed('activityLevelScore', function () {
      // 4 - 7 Sedentary
...
define('yabbit/models/stat', ['exports', 'ember-data'], function (exports, DS) {
  ...
  exports['default'] = DS['default'].Model.extend({
    ...
    title: DS['default'].attr('string'),
    stat: DS['default'].attr('number'),
    units: DS['default'].attr('string'),
...
define('yabbit/templates/components/stat-chart', ['exports'], function (exports) {
  ...
  exports['default'] = Ember.HTMLBars.template((function() {
    return {
      meta: {
        ...
        "moduleName": "yabbit/templates/components/stat-chart.hbs"
      },
      arity: 0,
      cachedFragment: null,
      hasRendered: false,
      buildFragment: function buildFragment(dom) {
        ...
        dom.setAttribute(el2,"class","stat-chart");
        var el3 = dom.createTextNode("\n    ");
        dom.appendChild(el2, el3);
        ...
        dom.setAttribute(el3,"class","stat-number");
      ...
      statements: [
        ["content","stat.units",["loc",[null,[4,30],[4,44]]]],
        ["content","stat.title",["loc",[null,[5,10],[5,24]]]],
        ["content","stat.stat",["loc",[null,[7,30],[7,43]]]]
      ],
      locals: [],
      templates: []
    };
  ...
  exports['default'] = Ember.HTMLBars.template((function() {
    ...
    var child1 = (function() {
      return {
        ...
        statements: [
          ["inline","stat-chart",[],["stat",["subexpr","@mut",[["get","stat",["loc",[null,[50,24],[50,28]]]]],[],[]]],["loc",[null,[50,6],[50,30]]]]
        ],
        locals: ["stat"],
        templates: []
      };
    ...
    return {
      ...
      statements: [
        ...
        ["block","each",[["get","model.stats",["loc",[null,[49,12],[49,23]]]]],[],1,null,["loc",[null,[49,4],[51,13]]]],
        ["block","link-to",["patients.index"],["id","view-all","class","button"],2,null,["loc",[null,[57,0],[57,78]]]]
      ],
      locals: [],
      templates: [child0, child1, child2]
    };
...
if (runningTests) {
  ...
  require("yabbit/app")["default"].create({"applicationId":"kAPizP7WxU9vD8ndEHZd4w14HBDANxCYi5VQQGJ9","restApiId":"1wRXdgIGcnCPoeywMgdNQ7THSbMO7UxWZYdvlfJN","name":"yabbit","version":"0.0.0+3f6ed419"});
}
